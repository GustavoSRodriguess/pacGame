...

{
    ...
    public Transform dest1, dest2, dest3, dest4, dest5, dest6, dest7, dest8, dest9, dest10, dest11, dest12, dest13, dest14, dest15, dest16, dest17, dest18, dest19, dest20, player;
...

    {
...

        {
...

            {
                ...
                this.transform.position = dest16.position;
...

            {
                ...
                this.transform.position = dest17.position;
...

            {
                ...
                this.transform.position = dest18.position;
...

            {
                ...
                this.transform.position = dest19.position;
...

            {
                ...
                this.transform.position = dest20.position;
